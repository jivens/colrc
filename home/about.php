...
<p> The archive also links to <a href="http://ivydoak.com/Coeurd'Alene/grammar/crgrammar.htm">Ivy Doak's grammatical sketch</a> of Coeur d'Alene.  Other websites with Coeur d'Alene material include the following: The official Coeur d'Alene <a href="http://www.cdatribe-nsn.gov/" target="_blank">website</a>; the 1917 publication of Teit's <a href="http://www.archive.org/stream/folktalesofsalis00boas#page/119/mode/1up" target="_blank">Coeur d'Alene "tales"</a> which include different versions of a small number of the Coeur d'Alene texts in the archive; and Reichard's 1938 grammar published in <a href="http://www.archive.org/stream/rosettaproject_tqw_morsyn-2#page/n529/mode/2up" target="_blank">The Handbook of American Indian Languages v. 3</a>. Reichard's 1947 <a href="http://archive.org/stream/analysisofcoeurd41reic#page/n5/mode/2up" target="_blank">An Analysis of Coeur d'Alene Indian Myths</a> is available at the University of Michigan Digital Library General Collection.  Lyon's 2010 <a href="http://www.sfu.ca/nwjl/Articles/V004_N02/LyonNicodemusCards.html" target="_blank">Lawrence Nicodemus's Snchitsu'umshtsn File Card Collection in Dictionary Format</a> is also linked from the left menu.
</p>

<p>The original Coeur d'Alene archive was created by Shannon Bischoff and Musa Yassin Fort in the summer of 2009. The original website was created without any prior web design/building knowledge using <a href="http://www.w3schools.com/" target="_blank">w3schools.com</a> free tutorials over a period of six weeks.  The site was constructed using simple html, javascript, and css code, all designed based on lessons at the site. The search mechanisms were a bit more complicated and required php, which can also be learned at the w3 schools website.</p>

<p>This version of the website is being revised with the support of the National Science Foundation (award numbers BCS-1160394 and BCS-1160627), but is still being developed using these freely available, open-source, and easily learnable tools - expanded to include xml and ajax. You can find free tutorials for all of these tools at <a href="http://www.w3schools.com" target="blank">w3schools.com</a>.  Additional resources will be included, as well as further documentation about the methods used by Reichard and Nicodemus to collect many of these resources. We also will be posting our source files (for all material other than the language resources themselves) to the site, so that anyone who'd like to make use of our code to develop their own websites may do so. If you would like to help or have questions, comments or suggestions, contact us using the "Contact Us" link on the left menu, or by emailing us directly at: <b>crd [dot] archive [at] gmail [dot] com</b>.</p>
